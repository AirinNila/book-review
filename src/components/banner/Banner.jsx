...
const Banner = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <img
      ...
      className="max-w-72 md:max-w-80 rounded-lg"
    />
    <div className='flex flex-col gap-4 md:pl-14 pl-4'>
      <h1 className="text-4xl md:text-6xl font-bold ">Books to freshen up your bookshelf</h1>
        <div>
            <Link to="/listed">
